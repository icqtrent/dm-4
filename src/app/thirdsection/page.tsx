...
const ThirdSection: React.FC<ThirdSectionProps> = ({ id }) => {
  return (
    <section id={id} className="flex p-10 flex-col md:flex-row md:justify-evenly">
          ...
          <div className="md:px-20 space-y-6 flex-col items-center justify-center">
            <div className="text-lg pt-10 flex gap-4">
              ...
              <div className="flex flex-col gap-2">
                Choose from a variety of store templates to Regístrate. And
